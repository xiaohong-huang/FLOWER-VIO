...
def process_item(i):
    ...
    f_idx=i%f_size+1
    print("rosrun", "flower_vio","flower_vio_node",config_name,
...
prefix="EUROC"
config_name="src/FLOWER-VIO/yaml/euroc_config.yaml"
run_func()
...
f_size=len(filenames)
prefix="TUM"
config_name="src/FLOWER-VIO/yaml/tum_config.yaml"
run_func()
...
f_size=len(filenames)
prefix="MY"
config_name="src/FLOWER-VIO/yaml/my_config.yaml"
run_func()
...
f_size=len(filenames)
prefix="4SEASONS"
config_name="src//FLOWER-VIO/yaml/4seasons_config.yaml"
run_func()