...
class IMUPreFactor {
  public:
    ...
    IMUFactor* factor = 0;
    std::vector<flower_vio::MatrixXd > imu_jacobians_in;
    flower_vio::Vector15d  imu_residual_in;
    flower_vio::Vector15d  imu_residual_in_save;
    flower_vio::Vector15d  model_residual_accum;
    flower_vio::Vector15d  model_residual_accum_save;
    flower_vio::Vector15d  imu_residual_in_linerized;
...
class VisualInertialBase  {
  public:
    ...
    void GetMatrixNext(flower_vio::MatrixXd& lhs, Eigen::VectorXd& rhs, std::vector<double*>& new_parameters, std::vector<int>& new_sizes);
    void Reset() {
        if (memory) {
    ...
    flower_vio::VectorXd prior_residual;
    flower_vio::VectorXd prior_residual_save;
    ...
    flower_vio::VectorXd prior_rhs;
    flower_vio::VectorXd prior_rhs_save;

    Eigen::Matrix<double, 1, 6, Eigen::RowMajor> yaw_constraint_jacobian;
    flower_vio::Vector1d yaw_constraint_residual;
    flower_vio::Vector1d yaw_constraint_residual_save;

    flower_vio::Vector1d yaw_constraint_model_residual_accum;
    flower_vio::Vector1d yaw_constraint_residual_linerized;
    flower_vio::Vector1d yaw_constraint_model_residual_accum_save;
    ...
    flower_vio::MatrixXd lhs_outside;
