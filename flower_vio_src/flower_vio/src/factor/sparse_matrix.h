...
class MatirxInfo {
  public:
    MatirxInfo(int idx1_, int idx2_, flower_vio::MatrixXd  m_, bool is_identity_, int b_row_, int b_col_): idx1(idx1_), idx2(idx2_), m(m_), is_identity(is_identity_),
...
inline void matrix_update(flower_vio::MatrixXd& A, flower_vio::MatrixXd B, flower_vio::MatrixXd& C, int a, int b,  bool is_left, bool is_identity, int B_ROW, int B_COL) {
...
inline void vector_update(Eigen::VectorXd& A, flower_vio::MatrixXd B, Eigen::VectorXd& C, int a, int b,  bool is_left, bool is_identity, int B_ROW, int B_COL) {
